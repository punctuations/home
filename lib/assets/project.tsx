export const Project = [
  ...
  },
  {
    ...
    links: [
      ...
      {
        href: "https://npmjs.org/wrap-presence",
        svg: (
          <svg
            width={16}
            height={16}
            fill="currentColor"
            strokeWidth={2}
            className="duration-500 transition-all opacity-40 dark:opacity-75 dark:hover:opacity-40 hover:opacity-75 dark:text-white mt-0.5"
            viewBox="0 0 16 16"
          >
            <title>npm</title>
            <path d="M0,16V0H16V16ZM3,3V13H8V5h3v8h2V3Z" />
          </svg>
        ),
      },
    ],
  ...
  },
  {
    ...
    links: [
      ...
      {
        href: "https://github.com/punctuations/cmdf",
        svg: (
          <svg
            width={20}
            height={20}
  ...
  },
  {
    ...
    links: [
      ...
      {
        href: "https://npmjs.org/use-listen-along",
        svg: (
          <svg
            width={16}
            height={16}
