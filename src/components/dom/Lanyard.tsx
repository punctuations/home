              ...
              <div className='flex flex-row items-center justify-center space-x-2'>
                <a
                  ...
                  href={`https://open.spotify.com/search/${
                    lanyard.spotify ? lanyard.spotify.song : 'Never Gonna Give You Up'
                  }%20-%20${lanyard.spotify ? lanyard.spotify.artist : 'Rick Astley'}`}
                  target='_blank'
                >
                  <figure className='flex flex-row items-end relative'>
                    ...
                    <figcaption>
                      <svg
                        ...
                        fill='currentColor'
                        viewBox='0 0 496 512'
                        className='absolute -bottom-1.5 -right-1.5 text-green-500 transition-colors duration-300 ease-in-out bg-black rounded-xl p-0.5'
                      >
                ...
                <div className='flex flex-col text-xs text-white w-3/4'>
                      ...
                      <div className='flex flex-row items-center justify-center space-x-2'>
                        <figure className='flex flex-row items-end relative'>
                          <img
                            ...
                            alt={activity.assets.large_text ? activity.assets.large_text : 'large_text'}
                            width={50}
                            height={50}
                            className='rounded-lg pointer-events-none border-2 border-black bg-black'
                          />
                          ...
                          {activity.assets.small_image ? (
                            <figcaption>
                              <img
                                ...
                                alt={activity.assets.small_text ? activity.assets.small_text : 'small_text'}
                                width={20}
                                height={20}
                                className='rounded-full absolute -bottom-1.5 -right-1.5 text-green-500 transition-colors duration-300 ease-in-out bg-black p-0.5'
                              />
                            </figcaption>
                          ) : null}
                        </figure>
                        ...
                        <div className='flex flex-col text-xs text-white'>
                          ...
                          <p>{activity.state ? activity.state : <>{activity.details ? activity.details : null}</>}</p>
                        </div>
                      </div>
                    )}
                  </>
