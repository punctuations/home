        ...
        <div className="2xl:grid xl:grid lg:grid md:grid sm:flex flex flex-col grid-cols-2 place-content-center 2xl:space-y-0 xl:space-y-0 lg:space-y-0 md:space-y-0 sm:space-y-0 space-y-6">
          ...
          <section className="flex items-center justify-center">
            <motion.div
              ...
              className="p-4 shadow-xl hover:shadow-2xl transition-shadow duration-500 flex flex-col space-x-4 space-y-4 rounded-lg w-11/12 border-gray-300 dark:border-gray-900 bg-white dark:bg-black border"
            >
